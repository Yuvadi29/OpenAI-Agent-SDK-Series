...
const customerFacingAgent = new Agent({
  ...
  instructions:
    ...
    handoffDescription: `You have 2 agents avalable:
    bookingAgent: Expert in handling booking queries and requests from users like booking a flight,
    refundAgent: Expert in handling refund related questions where the user asks for refund for a flight
    `,
    handoffs: [bookingAgent, refundAgent],
    tools: [fetchAvailableFlights]
})
...
runAgent(`Hey, Can i get a booking for SP1463 for Aditya Trivedi and 1 person travelling and also refund for AI1223`);
